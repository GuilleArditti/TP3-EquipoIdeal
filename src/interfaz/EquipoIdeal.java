...
public class EquipoIdeal implements ActionListener {
	...
	public void guardarGrupoEnArchivo(Set<Persona> grupoFuerzaBruta, Set<Persona> grupoHeuristica,
		...
		try (BufferedWriter writer = new BufferedWriter(new FileWriter(nombreArchivo + ".txt"))) {
			...
			writer.newLine();
			for (Persona persona : grupoFuerzaBruta) {
				writer.write("Nombre: " + persona.getNombre() + ", Rol: " + persona.getRol().toString()
						+ ", Calif.Historica: " + persona.getRendimiento());
				writer.newLine();
			}
			writer.newLine();
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == botonGuardarResultados) {
			String resultado = JOptionPane.showInputDialog(null, "Como va a llamar al archivo?", "Guardar",
